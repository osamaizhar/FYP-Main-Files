...
class TestPick():
	...
	right_arm.set_planning_time(5)
        ...
        start_pose.pose.position.x = -0.695156000000
        start_pose.pose.position.y = -0.302316000000
        start_pose.pose.position.z = 0.11719269305
	...
	right_arm.set_pose_target(next_pose)
        ...
        right_arm.set_named_target("staight leg")
        right_arm.go(wait=True)
